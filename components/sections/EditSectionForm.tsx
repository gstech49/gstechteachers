...
import { Section, Resource, MuxData } from "@prisma/client";
...
const EditSectionForm = ({
    ...
    return (
      ...
      <p className='text-sm font-medium mt-2'>
        Complete this section with detailed information, good video and resources to 
        ...
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <RichEditor placeholder="What is this section about?" 
                    {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          <div className="flex gap-5">
            <Link href={`/instructor/courses/${courseId}/sections`}><Button variant="outline" type="button">Cancel</Button></Link>
