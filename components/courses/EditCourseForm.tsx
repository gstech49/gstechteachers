...
interface EditCourseFormProps{
    course: Course
    categories:{
      label: string //name of a category
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Become a full-stack developer with just ONE course. HTML, CSS, Javascript, React, Node, MongoDB and more!" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <RichEditor placeholder="What is this course about?" 
                    {...field}
                    />
                  </FormControl>
                  <FormMessage />
